        ...
        <div className="container mx-auto px-4">
            ...
            <Card className="bg-white shadow-lg">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-lg">
                      A remarkable day of mathematical excellence and collaboration
                    </CardDescription>
                  </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Calgary Central High</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  The 2025 Calgary High School Mathematics Contest was an outstanding success, bringing together 
                  brilliant young minds from across the city. Students tackled challenging problems, participated 
                  in collaborative math battles, and demonstrated exceptional mathematical thinking. The event 
                  fostered a spirit of healthy competition while celebrating the beauty of mathematics.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className={`mb-12 transition-all duration-1000 delay-200 ${
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">Congratulations to our outstanding performers</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200 hover:shadow-xl transition-shadow duration-300">
                <CardHeader className="text-center">
                  ...
                  <Badge className="bg-yellow-500 text-white mb-2">1st Place</Badge>
                  <CardTitle className="text-xl">Sarah Chen</CardTitle>
                  <CardDescription>Western Canada High School</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-gray-700">
                    Exceptional performance across all problem categories with innovative solution approaches
                  </p>
                  <p className="font-semibold text-yellow-700 mt-2">Score: 94/100</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-gray-50 to-slate-100 border-2 border-gray-300 hover:shadow-xl transition-shadow duration-300">
                <CardHeader className="text-center">
                  ...
                  <Badge className="bg-gray-500 text-white mb-2">2nd Place</Badge>
                  <CardTitle className="text-xl">Marcus Rodriguez</CardTitle>
                  <CardDescription>Bishop Carroll High School</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-gray-700">
                    Outstanding mathematical reasoning and clear presentation of solutions
                  </p>
                  <p className="font-semibold text-gray-700 mt-2">Score: 89/100</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="text-center">
                  <p className="text-gray-700">
                    Creative problem-solving techniques and excellent teamwork during math battles
                  </p>
                  <p className="font-semibold text-orange-700 mt-2">Score: 85/100</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className={`mb-12 transition-all duration-1000 delay-300 ${
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">Capturing the spirit of mathematical excellence</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-6">
                  <CardTitle className="text-xl mb-2">Focused Problem Solving</CardTitle>
                  <CardDescription>
                    Students deeply engaged in tackling challenging mathematical problems with concentration and determination.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-6">
                  <CardTitle className="text-xl mb-2">Collaborative Math Battles</CardTitle>
                  <CardDescription>
                    Teams working together to present their solutions and mathematical reasoning to judges and peers.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent className="p-4">
                  ...
                  <CardDescription className="text-sm">
                    Celebrating achievements and recognizing mathematical excellence
                  </CardDescription>
                </CardContent>
              </Card>
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-purple-50">
              ...
              <CardContent>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h3 className="text-xl font-semibold mb-4 text-gray-800">Participant Testimonials</h3>
                  <div className="space-y-4">
                    <blockquote className="border-l-4 border-blue-500 pl-4 italic text-gray-700">
                      "This competition challenged me in ways I never expected. The problems were tough but fair, 
                      and the collaborative aspect made it even more enjoyable." - Alex M., Grade 11
                    </blockquote>
                    <blockquote className="border-l-4 border-green-500 pl-4 italic text-gray-700">
                      "The math battles were incredible! Working with teammates to solve complex problems 
                      taught me so much about mathematical communication." - Jessica L., Grade 12
                    </blockquote>
                  </div>
                </div>
              </CardContent>
