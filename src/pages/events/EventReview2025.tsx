				...
				<div className="container mx-auto px-4">
					...
					>
						<div className="mb-8 text-center">
							<h2 className="mb-4 flex items-center justify-center gap-3 text-3xl font-bold text-gray-800">
						...
						<div className="grid grid-cols-1 gap-8 md:grid-cols-3">
							{/* First Place */}
							<Card className="border-2 border-yellow-200 bg-gradient-to-br from-yellow-50 to-orange-50 transition-shadow duration-300 hover:shadow-xl">
							...
							{/* Second Place */}
							<Card className="border-2 border-gray-300 bg-gradient-to-br from-gray-50 to-slate-100 transition-shadow duration-300 hover:shadow-xl">
								<CardHeader className="text-center">
									<div className="mx-auto mb-4">
										<img
											src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face"
											alt="Second Place Winner"
											className="h-24 w-24 rounded-full border-4 border-gray-400 object-cover"
										/>
									</div>
									<Badge className="mb-2 bg-gray-500 text-white">
										2nd Place
									</Badge>
							...
							{/* Third Place */}
							<Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-red-50 transition-shadow duration-300 hover:shadow-xl">
								<CardHeader className="text-center">
									<div className="mx-auto mb-4">
										<img
					...
					>
						...
						<div className="relative mb-8">
							<div className="relative h-[600px] overflow-hidden rounded-lg">
									...
									{eventImages.map((image, index) => (
										...
										>
											<img
												...
												className="h-[480px] w-[640px] rounded-lg object-cover shadow-lg"
											/>
										</div>
									))}
								</div>
								...
								<Button
									onClick={prevImage}
									className="absolute left-8 top-1/2 z-20 -translate-y-1/2 transform rounded-full bg-white/80 p-2 text-gray-800 shadow-lg hover:bg-white"
									size="icon"
								>
								...
								<Button
									onClick={nextImage}
									className="absolute right-8 top-1/2 z-20 -translate-y-1/2 transform rounded-full bg-white/80 p-2 text-gray-800 shadow-lg hover:bg-white"
									size="icon"
								>
					...
					<div
						className={`delay-400 transition-all duration-1000 ${
							isVisible
								? "translate-y-0 opacity-100"
								: "translate-y-8 opacity-0"
						}`}
