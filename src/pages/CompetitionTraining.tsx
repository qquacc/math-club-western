...
const CompetitionTraining = () => {
  const competitions = [
    {
      name: "AMC 8",
      description: "American Mathematics Competitions 8 for middle school students",
      icon: Trophy,
      difficulty: "Beginner"
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {competitions.map((comp) => {
              ...
              return (
                <Card key={comp.name} className="hover:shadow-lg transition-shadow duration-300">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <span className="text-sm text-blue-600 font-medium">{comp.difficulty}</span>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
