...
const Leaderboard = () => {
  ...
  return (
    <section id="leaderboard" className="mb-12">
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Club Leaderboard</h2>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <div className="space-y-4">
            {topUsers.map((user) => (
              <div key={user.rank} className="flex items-center justify-between p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
